 ...
 */
--%>
<%@page import="vn.dtt.cmon.portlet.endorse.business.CitizenUserBs"%>
...
<%
	 ...
	 System.out.println("\n =====jsp keywordSearch:" + keywordSearch + ":reqStatus:" + reqStatus);
	...
	<div class="egov-container">
		...
		%>
			<div class="portlet-msg-success" style="padding-left : 40px;">
		 		
			 		Bạn đã thực hiện việc xác thực thành công tài khoản.<br> Bạn có thể sử dụng tài khoản vừa xác thực với mật khẩu mặc định là: <b style='color:red'>test</b> để đăng nhập dùng thử hệ thống Open EgovPlatform
			  ...
			  <tr>
			    ...
			    <td align = "right">
				    <select name="reqStatus" class="egov-select custom" onchange="submitFormEndorseee();">
				        ...
				        <option value="-1"  <%= selectedMinus1 %> >---Tất cả trạng thái---</option>				        
	...
	<%
		 ...
		 List<YeuCauDangKyCongDan>  result = CitizenUserBs.searchUserRequest(keywordSearch, reqStatusInt);
			...
			<td align="center">
				...
				%>
					<div style="padding-left: 10px;">
						...
						<a href="#" onclick="submitForm('<%=viewUrl%>', 'Bạn có muốn xác thực tài khoản này không ?');"  title="Xác thực nhanh">
