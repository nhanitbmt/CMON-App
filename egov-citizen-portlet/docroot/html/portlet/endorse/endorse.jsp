		...
		<form id="endorseForm" name="endorseForm" method="post" action="<%=endorseUrl%>">
			...
			%>
				<div class="portlet-msg-success" style="padding-left: 20px;">
			 		Bạn đã thực hiện việc xác thực thành công tài khoản. Bạn có thể sử dụng tài khoản vừa xác thực với mật khẩu mặc định là: <b>test</b> để đăng nhập dùng thử hệ thống Open EgovPlatform
			 	 </div>
			<%
		  ...
		  <table class = "egov-table-form" style = 'width:90%'>
		  	<tr>
				<td colspan="6">
					<select style="display: none;" id="egov-form-errors">
						<option value="ho">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.hoCongDan" message = "vn.dtt.cmon.user.form.endorse.err.hoCongDan"/>
						</option>
						<option value="ten">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.tenCongDan" message = "vn.dtt.cmon.user.form.endorse.err.tenCongDan"/>
						</option>
		  				<option value="soCmnd">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.soCmnd"  message = "Số Chứng minh nhân dân không được để trống và phải có 9 hoặc 12 số" />
						</option>
						<option value="ngayCapCmnd">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.ngayCapCmnd"  message = "vn.dtt.cmon.user.form.endorse.err.ngayCapCmnd" />
						</option>
						<option value="ngayCapCmnd">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.ngayCap.greaterThanCurrent"  message = "Ngày cấp không được lớn hơn hiện tại" />
						</option>
						
		  				<option value="email">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.email"  message = "Địa chỉ email không được để trống và phải đúng định dạng" />
						</option>
						<option value="email">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.emailDuplicate"  message = "Địa chỉ email đã được sử dụng" />
						</option>
						
		  				<option value="gioiTinh">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.gioiTinh"  message = "vn.dtt.cmon.user.form.endorse.err.gioiTinh" />
						</option>
		  				<option value="ngaySinh">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.ngaySinh"  message = "vn.dtt.cmon.user.form.endorse.err.ngaySinh" />
						</option>
		  				<option value="ngaySinh">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.ngaySinh.greaterThanCurrent"  message = "vn.dtt.cmon.user.form.endorse.err.ngaySinh.greaterThanCurrent" />
						</option>
						
						
						<option value="thuongtru_tinhthanh">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.tinhThuongTru"  message = "vn.dtt.cmon.user.form.endorse.err.tinhThuongTru" />
						</option>
						
						<option value="thuongtru_quanhuyen">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.huyenThuongTru"  message = "vn.dtt.cmon.user.form.endorse.err.huyenThuongTru" />
						</option>
						
						<option value="thuongtru_phuongxa">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.xaThuongTru"  message = "vn.dtt.cmon.user.form.endorse.err.xaThuongTru" />
						</option>
						
						<option value="tinhHienTai">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.tinhHienTai"  message = "vn.dtt.cmon.user.form.endorse.err.tinhHienTai" />
						</option>
						
						<option value="danToc">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.danToc"  message = "vn.dtt.cmon.user.form.endorse.err.danToc" />
						</option>
						
						<option value="tonGiao">
							<liferay-ui:error key="vn.dtt.cmon.user.form.endorse.err.tonGiao"  message = "vn.dtt.cmon.user.form.endorse.err.tonGiao" />
						</option>
		  			</select>
		  		</td>
		  	</tr>
		    ...
		    <!--  ho ten  ngay sinh-->
		     <tr>
		      <td colspan="3" scope="col"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.hoVaTen"/></label>
		      	<label class="egov-label-red">(*)</label></td>
		      <td colspan="1"></td>
		      <td colspan="2"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.ngaySinh" /></label>
		      	<label class="egov-label-red">(*)</label></td>
		    </tr>
		    <tr>
			...
			<!-- cmnd -->
			<tr>
		      <td colspan="3"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.soCmnd" /></label>
		      	 <label class="egov-label-red">(*)</label></td>
		      <td></td>
		      <td colspan="2">
		      	<label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.ngayCapCmnd" /></label>
			...
			<!-- gioi tinh, dan toc, ton giao -->
			 <tr>
		      <td colspan="2"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.gioiTinh" /></label>
		      	 <label class="egov-label-red">(*)</label></td>
		      <td colspan="2"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.danToc" /></label><label class="egov-label-red">(*)</label></td>
		      <td colspan="2"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.tonGiao" /></label><label class="egov-label-red">(*)</label></td>
		    </tr>
		    <tr>
		      <td colspan="2">
			      <%
		   ...
		   <tr>
			   <td colspan="6"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.user.form.endorse.motaThuongTru" /></label></td>
		   </tr>
		   <tr>
			 <td colspan="6">
		      ...
		      <td colspan="6" align = "center">
				...
				redirectUrl.setParameter("jspPage","/html/portlet/endorse/endorse.jsp");
		     	...
		     	<%  } %>
		      	...
		      	<a href = "<%=backUrl %>" >
		      		<input type="button" id="backButton" class = "egov-button" name="backButton"  value="<liferay-ui:message key="vn.dtt.cmon.user.form.endorse.backButton"/>" />
		      	</a>		      	
		      </td>
		    </tr>
		  </table>
