...
<%@page import="vn.dtt.cmon.utils.DateUtil"%>
...
<%
	...
	CongDan congDan = CongDanLocalServiceUtil.findByNgaySinhAndSoCMND(DateUtil.parseStringToDate(userRequest.get("NGAYSINH")), userRequest.get("SOCMND"));
	...
	<div class="egov-container">	
		<form id="endorseForm" name="endorseForm" method="post" action="<%=inputDetailUrlExist%>">
		  <table cellspacing="0" cellpadding="0" class="egov-table-form">
		   ...
		   <!--  <tr>
		      <td width="10" colspan="3" scope="col"><label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.userreg.form.input.hoVaTen"/> <font color = "red">(*)</font></label></td>
		    ...
		    <tr>
		      ...
		      <input name="ten" type="text" id="ten"  maxlength="20" class = "egov-inputfield" value = "<%=congDanExist.getTen()%>" style = 'width:85%'/></td>
		       ...
		       <label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.userreg.form.input.ngaySinh" /> <font color = "red">(*)</font></label>
		         <br>
		         <input name="ngaySinh" type="text" id="ngaySinh" class = "egov-calendar   " value = "<%=DateUtil.parseDateToTring(congDanExist.getNgaySinh())%>" style = 'width:100%'/>
		    ...
		    <tr>
		      ...
		      <br>
		      <input name="ngayCapCmnd" type="text" id="ngayCapCmnd" maxlength="10" class = "egov-calendar   " value = "<%=DateUtil.parseDateToTring(congDanExist.getNgayCapCmnd())%>" style = 'width:95%'/>
		      </td>
		    ...
		    <tr>
		    	<td colspan="6">
			    	<label class ="egov-label-bold"><liferay-ui:message key="vn.dtt.cmon.userreg.form.input.motaThuongTru" /></label>
			    	<br>
			    	 <input name="motaThuongTru" type="text" id="motaThuongTru"  maxlength="100" class = "egov-inputfield" value = "<%=congDanExist.getDiaChiThuongTru()%>" style = 'width:100%'/>
