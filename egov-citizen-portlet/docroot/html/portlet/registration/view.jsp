	  ...
	  <table cellspacing="0" cellpadding="0" class="egov-table-form" width="100%">
	  	...
	  	<% 
			PortletURL inputDetailDialogUrl = renderResponse.createRenderURL();
	  		inputDetailDialogUrl.setParameter("jspPage","/html/portlet/registration/input_detail_dialog.jsp");
            ...
            redirectUrl.setParameter("jspPage","/html/portlet/registration/view.jsp");
		...
		%>
	  	...
	  	<table cellspacing="0" cellpadding="0" class="egov-table-form"  width="100%">
	    <tr>
	      <td style="padding-top: 2px;" width="25%"><font style="font-weight: bold; padding-top: 5px;">Họ - Đệm - Tên</font> <font color = "red">(*)</font></td>
     	<td  width="25%">
   			<input style = 'width:85%;' name="ho" value = "<%=userRequest.get("HOCONGDAN")%>" type="text" id="ho" maxlength="20" class = "egov-inputfield" />
   		</td>
   		<td  width="25%">
   			<input style = 'width:85%' name="dem" type="text" id="dem" value = "<%=userRequest.get("TENDEM")%>" maxlength="50"  class = "egov-inputfield " />
   		</td>
   		<td  width="25%">
   			<input name="ten" type="text" id="ten" value = "<%=userRequest.get("TENCONGDAN")%>" maxlength="20" class = "egov-inputfield" style = 'width:85%; '/>
   		</td>
	      	 ...
	      	 <table class="egov-table-form" >
		      	<tr>
		      		<td  style="padding-top: 20px;">
		      			<input type="text" id = "captcha" name = "captcha" class = "egov-inputfield" maxlength = "20" style = 'width:95%; margin-top: -7px;'>
		      		</td>
		      		<td  style="padding-top: 12px;">
		      			 <portlet:resourceURL var="captchaURL" id="captcha"/>
							...
							<input id="reloadcapchar" name="reloadcapchar" type="hidden" value="" style = ' margin-top: -7px;'/>
	    ...
	    <tr>
	      <td>&nbsp;</td>
	      <td colspan="3"><input type="submit" name="button2" id="button2" value="Đăng ký tài khoản" class = "egov-button"/></td>
	    </tr>
