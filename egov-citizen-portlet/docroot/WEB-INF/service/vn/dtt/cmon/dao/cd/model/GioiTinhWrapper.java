...
public class GioiTinhWrapper implements GioiTinh, ModelWrapper<GioiTinh> {
	...
	*/
	...
	public int compareTo(vn.dtt.cmon.dao.cd.model.GioiTinh gioiTinh) {
	...
	public com.liferay.portal.model.CacheModel<vn.dtt.cmon.dao.cd.model.GioiTinh> toCacheModel() {
		return _gioiTinh.toCacheModel();
	}

	public vn.dtt.cmon.dao.cd.model.GioiTinh toEscapedModel() {
