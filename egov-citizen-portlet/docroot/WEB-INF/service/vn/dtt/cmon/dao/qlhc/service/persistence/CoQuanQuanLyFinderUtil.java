...
public class CoQuanQuanLyFinderUtil {
	public static java.util.List<vn.dtt.cmon.dao.qlhc.model.CoQuanQuanLy> getDSCoQuanQuanlyByDonViHanhChinhId(
		java.lang.String donviHanhChinhIds) {
		return getFinder().getDSCoQuanQuanlyByDonViHanhChinhId(donviHanhChinhIds);
	}

	public static java.util.List<vn.dtt.cmon.dao.qlhc.model.CoQuanQuanLy> getDSCoQuanQuanlyByMaOrTen(
	...
	public static CoQuanQuanLyFinder getFinder() {
		if (_finder == null) {
			_finder = (CoQuanQuanLyFinder)PortletBeanLocatorUtil.locate(vn.dtt.cmon.dao.qlhc.service.ClpSerializer.getServletContextName(),
