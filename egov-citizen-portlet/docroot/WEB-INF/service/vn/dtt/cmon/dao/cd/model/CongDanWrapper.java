...
public class CongDanWrapper implements CongDan, ModelWrapper<CongDan> {
	...
	*/
	...
	public int compareTo(vn.dtt.cmon.dao.cd.model.CongDan congDan) {
	...
	public com.liferay.portal.model.CacheModel<vn.dtt.cmon.dao.cd.model.CongDan> toCacheModel() {
		return _congDan.toCacheModel();
	}

	public vn.dtt.cmon.dao.cd.model.CongDan toEscapedModel() {
