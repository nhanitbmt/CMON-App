...
public class GioiTinhLocalServiceClp implements GioiTinhLocalService {
	public GioiTinhLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addGioiTinhMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addGioiTinh", vn.dtt.cmon.dao.cd.model.GioiTinh.class);
		...
		_deleteGioiTinhMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteGioiTinh", vn.dtt.cmon.dao.cd.model.GioiTinh.class);
		...
		_updateGioiTinhMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateGioiTinh", vn.dtt.cmon.dao.cd.model.GioiTinh.class);
	...
	public vn.dtt.cmon.dao.cd.model.GioiTinh addGioiTinh(
		...
		return (vn.dtt.cmon.dao.cd.model.GioiTinh)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dao.cd.model.GioiTinh> getGioiTinhs(
		...
		return (java.util.List<vn.dtt.cmon.dao.cd.model.GioiTinh>)ClpSerializer.translateOutput(returnObj);
	}
