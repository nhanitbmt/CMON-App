...
public class DanTocWrapper implements DanToc, ModelWrapper<DanToc> {
	...
	*/
	...
	public int compareTo(vn.dtt.cmon.dao.cd.model.DanToc danToc) {
	...
	public com.liferay.portal.model.CacheModel<vn.dtt.cmon.dao.cd.model.DanToc> toCacheModel() {
		return _danToc.toCacheModel();
	}

	public vn.dtt.cmon.dao.cd.model.DanToc toEscapedModel() {
