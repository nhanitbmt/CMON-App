 ...
 * @author LIEMNN
 */
public class TonGiaoClp extends BaseModelImpl<TonGiao> implements TonGiao {
	public TonGiaoClp() {
	}
	...
	public TonGiao toEscapedModel() {
		return (TonGiao)Proxy.newProxyInstance(TonGiao.class.getClassLoader(),
			new Class[] { TonGiao.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		TonGiaoClp clone = new TonGiaoClp();
	...
	public boolean equals(Object obj) {
		...
		TonGiaoClp tonGiao = null;

		try {
			tonGiao = (TonGiaoClp)obj;
		}
