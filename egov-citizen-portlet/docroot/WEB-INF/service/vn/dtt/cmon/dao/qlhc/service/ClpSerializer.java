...
import vn.dtt.cmon.dao.qlhc.model.CapCoQuanQuanLyClp;
import vn.dtt.cmon.dao.qlhc.model.CapDonViHanhChinhClp;
import vn.dtt.cmon.dao.qlhc.model.ChucVu2VaiTroClp;
import vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiepClp;
import vn.dtt.cmon.dao.qlhc.model.CoQuanQuanLyClp;
import vn.dtt.cmon.dao.qlhc.model.DonViHanhChinhClp;
import vn.dtt.cmon.dao.qlhc.model.QuocGiaClp;
...
public class ClpSerializer {
	...
	public static Object translateInputCapCoQuanQuanLy(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("vn.dtt.cmon.dao.qlhc.model.impl.CapCoQuanQuanLyImpl",
						true, _classLoader);
	...
	public static Object translateInputCapDonViHanhChinh(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("vn.dtt.cmon.dao.qlhc.model.impl.CapDonViHanhChinhImpl",
						true, _classLoader);
	...
	public static Object translateInputChucVu2VaiTro(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("vn.dtt.cmon.dao.qlhc.model.impl.ChucVu2VaiTroImpl",
						true, _classLoader);
	...
	public static Object translateInputCoQuanHanhChinhSuNghiep(
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("vn.dtt.cmon.dao.qlhc.model.impl.CoQuanHanhChinhSuNghiepImpl",
						true, _classLoader);
	...
	public static Object translateInputCoQuanQuanLy(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("vn.dtt.cmon.dao.qlhc.model.impl.CoQuanQuanLyImpl",
						true, _classLoader);
	...
	public static Object translateInputDonViHanhChinh(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("vn.dtt.cmon.dao.qlhc.model.impl.DonViHanhChinhImpl",
						true, _classLoader);
	...
	public static Object translateInputQuocGia(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("vn.dtt.cmon.dao.qlhc.model.impl.QuocGiaImpl",
						true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"vn.dtt.cmon.dao.qlhc.model.impl.CapCoQuanQuanLyImpl")) {
			return translateOutputCapCoQuanQuanLy(oldModel);
		}

		if (oldModelClassName.equals(
					"vn.dtt.cmon.dao.qlhc.model.impl.CapDonViHanhChinhImpl")) {
			return translateOutputCapDonViHanhChinh(oldModel);
		}

		if (oldModelClassName.equals(
					"vn.dtt.cmon.dao.qlhc.model.impl.ChucVu2VaiTroImpl")) {
			return translateOutputChucVu2VaiTro(oldModel);
		}

		if (oldModelClassName.equals(
					"vn.dtt.cmon.dao.qlhc.model.impl.CoQuanHanhChinhSuNghiepImpl")) {
			return translateOutputCoQuanHanhChinhSuNghiep(oldModel);
		}

		if (oldModelClassName.equals(
					"vn.dtt.cmon.dao.qlhc.model.impl.CoQuanQuanLyImpl")) {
			return translateOutputCoQuanQuanLy(oldModel);
		}

		if (oldModelClassName.equals(
					"vn.dtt.cmon.dao.qlhc.model.impl.DonViHanhChinhImpl")) {
			return translateOutputDonViHanhChinh(oldModel);
		}

		if (oldModelClassName.equals(
					"vn.dtt.cmon.dao.qlhc.model.impl.QuocGiaImpl")) {
