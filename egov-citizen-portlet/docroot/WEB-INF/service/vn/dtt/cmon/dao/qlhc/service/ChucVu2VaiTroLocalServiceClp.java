...
public class ChucVu2VaiTroLocalServiceClp implements ChucVu2VaiTroLocalService {
	public ChucVu2VaiTroLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addChucVu2VaiTroMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addChucVu2VaiTro",
				vn.dtt.cmon.dao.qlhc.model.ChucVu2VaiTro.class);
		...
		_updateChucVu2VaiTroMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateChucVu2VaiTro",
				vn.dtt.cmon.dao.qlhc.model.ChucVu2VaiTro.class, boolean.class);
	...
	public vn.dtt.cmon.dao.qlhc.model.ChucVu2VaiTro addChucVu2VaiTro(
		...
		return (vn.dtt.cmon.dao.qlhc.model.ChucVu2VaiTro)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dao.qlhc.model.ChucVu2VaiTro> getChucVu2VaiTros(
		...
		return (java.util.List<vn.dtt.cmon.dao.qlhc.model.ChucVu2VaiTro>)ClpSerializer.translateOutput(returnObj);
	}
