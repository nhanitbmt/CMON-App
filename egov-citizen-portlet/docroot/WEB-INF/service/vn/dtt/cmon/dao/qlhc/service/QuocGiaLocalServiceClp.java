...
public class QuocGiaLocalServiceClp implements QuocGiaLocalService {
	public QuocGiaLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addQuocGiaMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addQuocGia", vn.dtt.cmon.dao.qlhc.model.QuocGia.class);
		...
		_deleteQuocGiaMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteQuocGia", vn.dtt.cmon.dao.qlhc.model.QuocGia.class);
		...
		_updateQuocGiaMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateQuocGia", vn.dtt.cmon.dao.qlhc.model.QuocGia.class);
	...
	public vn.dtt.cmon.dao.qlhc.model.QuocGia addQuocGia(
		...
		return (vn.dtt.cmon.dao.qlhc.model.QuocGia)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dao.qlhc.model.QuocGia> getQuocGias(
		...
		return (java.util.List<vn.dtt.cmon.dao.qlhc.model.QuocGia>)ClpSerializer.translateOutput(returnObj);
	}
