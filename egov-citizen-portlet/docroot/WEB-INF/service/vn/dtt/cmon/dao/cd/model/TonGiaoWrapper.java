...
public class TonGiaoWrapper implements TonGiao, ModelWrapper<TonGiao> {
	...
	*/
	...
	public int compareTo(vn.dtt.cmon.dao.cd.model.TonGiao tonGiao) {
	...
	public com.liferay.portal.model.CacheModel<vn.dtt.cmon.dao.cd.model.TonGiao> toCacheModel() {
		return _tonGiao.toCacheModel();
	}

	public vn.dtt.cmon.dao.cd.model.TonGiao toEscapedModel() {
