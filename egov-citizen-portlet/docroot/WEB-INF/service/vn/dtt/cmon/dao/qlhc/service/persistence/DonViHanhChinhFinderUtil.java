...
public class DonViHanhChinhFinderUtil {
	public static java.util.List<vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh> dsTinhThanh() {
		return getFinder().dsTinhThanh();
	}

	public static DonViHanhChinhFinder getFinder() {
		if (_finder == null) {
			_finder = (DonViHanhChinhFinder)PortletBeanLocatorUtil.locate(vn.dtt.cmon.dao.qlhc.service.ClpSerializer.getServletContextName(),
