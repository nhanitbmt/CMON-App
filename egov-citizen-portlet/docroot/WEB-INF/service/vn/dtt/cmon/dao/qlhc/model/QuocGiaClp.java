 ...
 * @author LIEMNN
 */
public class QuocGiaClp extends BaseModelImpl<QuocGia> implements QuocGia {
	public QuocGiaClp() {
	}
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			QuocGiaLocalServiceUtil.addQuocGia(this);
		}
		else {
			QuocGiaLocalServiceUtil.updateQuocGia(this);
		}
	}

	@Override
	public QuocGia toEscapedModel() {
		return (QuocGia)Proxy.newProxyInstance(QuocGia.class.getClassLoader(),
			new Class[] { QuocGia.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		QuocGiaClp clone = new QuocGiaClp();
	...
	public boolean equals(Object obj) {
		...
		QuocGiaClp quocGia = null;

		try {
			quocGia = (QuocGiaClp)obj;
		}
