...
public class CoQuanHanhChinhSuNghiepUtil {
	...
	*/
	public static void cacheResult(
		java.util.List<vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep> coQuanHanhChinhSuNghieps) {
	...
	*/
	public static vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep create(
		long id) {
	...
	* @throws vn.dtt.cmon.dao.qlhc.NoSuchCoQuanHanhChinhSuNghiepException if a co quan hanh chinh su nghiep with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep remove(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.cmon.dao.qlhc.NoSuchCoQuanHanhChinhSuNghiepException {
		return getPersistence().remove(id);
	}

	public static vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep updateImpl(
		vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep coQuanHanhChinhSuNghiep,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	/**
	* Returns the co quan hanh chinh su nghiep with the primary key or throws a {@link vn.dtt.cmon.dao.qlhc.NoSuchCoQuanHanhChinhSuNghiepException} if it could not be found.
	*
	* @param id the primary key of the co quan hanh chinh su nghiep
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.cmon.dao.qlhc.NoSuchCoQuanHanhChinhSuNghiepException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.cmon.dao.qlhc.model.CoQuanHanhChinhSuNghiep> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CoQuanHanhChinhSuNghiepPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CoQuanHanhChinhSuNghiepPersistence)PortletBeanLocatorUtil.locate(vn.dtt.cmon.dao.qlhc.service.ClpSerializer.getServletContextName(),
