...
/**
 * The interface for the gioi tinh local service.
 *
 * <p>
...
public interface GioiTinhLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GioiTinhLocalServiceUtil} to access the gioi tinh local service. Add custom service methods to {@link vn.dtt.cmon.dao.cd.service.impl.GioiTinhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public vn.dtt.cmon.dao.cd.model.GioiTinh addGioiTinh(
		vn.dtt.cmon.dao.cd.model.GioiTinh gioiTinh)
	...
	*/
	public vn.dtt.cmon.dao.cd.model.GioiTinh createGioiTinh(long id);
	...
	* @throws SystemException if a system exception occurred
	*/
	public void deleteGioiTinh(vn.dtt.cmon.dao.cd.model.GioiTinh gioiTinh)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	...
	public vn.dtt.cmon.dao.cd.model.GioiTinh fetchGioiTinh(long id)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public vn.dtt.cmon.dao.cd.model.GioiTinh getGioiTinh(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<vn.dtt.cmon.dao.cd.model.GioiTinh> getGioiTinhs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	* @throws SystemException if a system exception occurred
	*/
	public vn.dtt.cmon.dao.cd.model.GioiTinh updateGioiTinh(
		vn.dtt.cmon.dao.cd.model.GioiTinh gioiTinh)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	...
	/**
	* This is function get all GioiTinh of Vietnam is actived
	*
	* @author Hung.hoang
	* @date 25/09/2013     *
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<vn.dtt.cmon.dao.cd.model.GioiTinh> getDSGioiTinh();
}