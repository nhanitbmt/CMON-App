...
public class DonViHanhChinhLocalServiceClp implements DonViHanhChinhLocalService {
	public DonViHanhChinhLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addDonViHanhChinhMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addDonViHanhChinh",
				vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh.class);
		...
		_updateDonViHanhChinhMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateDonViHanhChinh",
				vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh.class, boolean.class);
	...
	public vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh addDonViHanhChinh(
		...
		return (vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh> getDonViHanhChinhs(
		...
		return (java.util.List<vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public vn.dtt.cmon.dao.qlhc.model.DonViHanhChinh findByMaDVHC(
		...
		try {
			...
			if (t instanceof vn.dtt.cmon.dao.qlhc.NoSuchDonViHanhChinhException) {
				throw (vn.dtt.cmon.dao.qlhc.NoSuchDonViHanhChinhException)t;
			}
