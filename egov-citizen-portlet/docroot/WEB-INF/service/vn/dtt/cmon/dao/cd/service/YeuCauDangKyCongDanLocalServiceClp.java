...
public class YeuCauDangKyCongDanLocalServiceClp
	...
	public YeuCauDangKyCongDanLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addYeuCauDangKyCongDanMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				...
				vn.dtt.cmon.dao.cd.model.YeuCauDangKyCongDan.class);
	...
	public vn.dtt.cmon.dao.cd.model.YeuCauDangKyCongDan addYeuCauDangKyCongDan(
		...
		return (vn.dtt.cmon.dao.cd.model.YeuCauDangKyCongDan)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dao.cd.model.YeuCauDangKyCongDan> getYeuCauDangKyCongDans(
		...
		return (java.util.List<vn.dtt.cmon.dao.cd.model.YeuCauDangKyCongDan>)ClpSerializer.translateOutput(returnObj);
	}
