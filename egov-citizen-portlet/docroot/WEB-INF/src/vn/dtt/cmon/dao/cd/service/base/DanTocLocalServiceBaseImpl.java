...
/**
 * The base implementation of the dan toc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.dao.cd.service.impl.DanTocLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNN
 ...
 * @generated
 */
public abstract class DanTocLocalServiceBaseImpl implements DanTocLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.dao.cd.service.DanTocLocalServiceUtil} to access the dan toc local service.
	 */
	 ...
	 */
	public DanToc addDanToc(DanToc danToc) throws SystemException {
		danToc.setNew(true);

		danToc = danTocPersistence.update(danToc, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(danToc);
			}
	 ...
	 */
	public DanToc createDanToc(long id) {
		return danTocPersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDanToc(long id) throws PortalException, SystemException {
		DanToc danToc = danTocPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(danToc);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDanToc(DanToc danToc) throws SystemException {
		danTocPersistence.remove(danToc);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return danTocPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return danTocPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return danTocPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DanToc fetchDanToc(long id) throws SystemException {
		return danTocPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanToc getDanToc(long id) throws PortalException, SystemException {
		return danTocPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return danTocPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DanToc> getDanTocs(int start, int end)
		throws SystemException {
		return danTocPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDanTocsCount() throws SystemException {
		return danTocPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanToc updateDanToc(DanToc danToc) throws SystemException {
		return updateDanToc(danToc, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanToc updateDanToc(DanToc danToc, boolean merge)
		throws SystemException {
		danToc.setNew(false);

		danToc = danTocPersistence.update(danToc, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.dao.cd.model.DanToc",
			danTocLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.cmon.dao.cd.model.DanToc");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = danTocPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DanTocLocalServiceBaseImpl.class);
