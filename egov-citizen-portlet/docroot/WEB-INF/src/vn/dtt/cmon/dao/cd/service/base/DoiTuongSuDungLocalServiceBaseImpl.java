...
/**
 * The base implementation of the doi tuong su dung local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.dao.cd.service.impl.DoiTuongSuDungLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNN
...
public abstract class DoiTuongSuDungLocalServiceBaseImpl
	implements DoiTuongSuDungLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.dao.cd.service.DoiTuongSuDungLocalServiceUtil} to access the doi tuong su dung local service.
	 */
	...
	public DoiTuongSuDung addDoiTuongSuDung(DoiTuongSuDung doiTuongSuDung)
		...
		doiTuongSuDung = doiTuongSuDungPersistence.update(doiTuongSuDung, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(doiTuongSuDung);
			}
	...
	public void deleteDoiTuongSuDung(long id)
		...
		DoiTuongSuDung doiTuongSuDung = doiTuongSuDungPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(doiTuongSuDung);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDoiTuongSuDung(DoiTuongSuDung doiTuongSuDung)
		throws SystemException {
		doiTuongSuDungPersistence.remove(doiTuongSuDung);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DoiTuongSuDung getDoiTuongSuDung(long id)
		throws PortalException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDoiTuongSuDungsCount() throws SystemException {
	...
	public DoiTuongSuDung updateDoiTuongSuDung(DoiTuongSuDung doiTuongSuDung)
		throws SystemException {
		return updateDoiTuongSuDung(doiTuongSuDung, true);
	}
	...
	public DoiTuongSuDung updateDoiTuongSuDung(DoiTuongSuDung doiTuongSuDung,
		...
		doiTuongSuDung = doiTuongSuDungPersistence.update(doiTuongSuDung, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.dao.cd.model.DoiTuongSuDung",
			doiTuongSuDungLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.cmon.dao.cd.model.DoiTuongSuDung");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(DoiTuongSuDungLocalServiceBaseImpl.class);
