...
import vn.dtt.cmon.dao.cd.NoSuchGioiTinhException;
import vn.dtt.cmon.dao.cd.model.GioiTinh;
import vn.dtt.cmon.dao.cd.model.impl.GioiTinhImpl;
import vn.dtt.cmon.dao.cd.model.impl.GioiTinhModelImpl;
...
public class GioiTinhPersistenceImpl extends BasePersistenceImpl<GioiTinh>
	...
	@Override
	public GioiTinh updateImpl(vn.dtt.cmon.dao.cd.model.GioiTinh gioiTinh,
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.dtt.cmon.dao.cd.model.GioiTinh")));
