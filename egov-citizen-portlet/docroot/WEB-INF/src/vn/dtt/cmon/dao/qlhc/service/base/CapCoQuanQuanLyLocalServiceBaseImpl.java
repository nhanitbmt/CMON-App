...
/**
 * The base implementation of the cap co quan quan ly local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.dao.qlhc.service.impl.CapCoQuanQuanLyLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNN
 ...
 * @generated
 */
public abstract class CapCoQuanQuanLyLocalServiceBaseImpl
	implements CapCoQuanQuanLyLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.dao.qlhc.service.CapCoQuanQuanLyLocalServiceUtil} to access the cap co quan quan ly local service.
	 */
	 ...
	 */
	public CapCoQuanQuanLy addCapCoQuanQuanLy(CapCoQuanQuanLy capCoQuanQuanLy)
		throws SystemException {
		capCoQuanQuanLy.setNew(true);

		capCoQuanQuanLy = capCoQuanQuanLyPersistence.update(capCoQuanQuanLy,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(capCoQuanQuanLy);
			}
	 ...
	 */
	public CapCoQuanQuanLy createCapCoQuanQuanLy(long id) {
		return capCoQuanQuanLyPersistence.create(id);
	}
	...
	public void deleteCapCoQuanQuanLy(long id)
		...
		CapCoQuanQuanLy capCoQuanQuanLy = capCoQuanQuanLyPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(capCoQuanQuanLy);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCapCoQuanQuanLy(CapCoQuanQuanLy capCoQuanQuanLy)
		throws SystemException {
		capCoQuanQuanLyPersistence.remove(capCoQuanQuanLy);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return capCoQuanQuanLyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return capCoQuanQuanLyPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CapCoQuanQuanLy fetchCapCoQuanQuanLy(long id)
		throws SystemException {
		return capCoQuanQuanLyPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CapCoQuanQuanLy getCapCoQuanQuanLy(long id)
		throws PortalException, SystemException {
		return capCoQuanQuanLyPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return capCoQuanQuanLyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CapCoQuanQuanLy> getCapCoQuanQuanLies(int start, int end)
		throws SystemException {
		return capCoQuanQuanLyPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCapCoQuanQuanLiesCount() throws SystemException {
		return capCoQuanQuanLyPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CapCoQuanQuanLy updateCapCoQuanQuanLy(
		CapCoQuanQuanLy capCoQuanQuanLy) throws SystemException {
		return updateCapCoQuanQuanLy(capCoQuanQuanLy, true);
	}
	 ...
	 */
	public CapCoQuanQuanLy updateCapCoQuanQuanLy(
		CapCoQuanQuanLy capCoQuanQuanLy, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.dao.qlhc.model.CapCoQuanQuanLy",
			capCoQuanQuanLyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.cmon.dao.qlhc.model.CapCoQuanQuanLy");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = capCoQuanQuanLyPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(CapCoQuanQuanLyLocalServiceBaseImpl.class);
