...
import vn.dtt.cmon.dao.cd.NoSuchTonGiaoException;
import vn.dtt.cmon.dao.cd.model.TonGiao;
import vn.dtt.cmon.dao.cd.model.impl.TonGiaoImpl;
import vn.dtt.cmon.dao.cd.model.impl.TonGiaoModelImpl;
...
public class TonGiaoPersistenceImpl extends BasePersistenceImpl<TonGiao>
	...
	@Override
	public TonGiao updateImpl(vn.dtt.cmon.dao.cd.model.TonGiao tonGiao,
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.dtt.cmon.dao.cd.model.TonGiao")));
