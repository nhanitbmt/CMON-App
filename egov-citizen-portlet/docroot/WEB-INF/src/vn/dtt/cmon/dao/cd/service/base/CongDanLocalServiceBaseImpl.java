...
/**
 * The base implementation of the cong dan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.dao.cd.service.impl.CongDanLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNN
 ...
 * @generated
 */
public abstract class CongDanLocalServiceBaseImpl implements CongDanLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.dao.cd.service.CongDanLocalServiceUtil} to access the cong dan local service.
	 */
	 ...
	 */
	public CongDan addCongDan(CongDan congDan) throws SystemException {
		congDan.setNew(true);

		congDan = congDanPersistence.update(congDan, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(congDan);
			}
	 ...
	 */
	public CongDan createCongDan(long id) {
		return congDanPersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCongDan(long id) throws PortalException, SystemException {
		CongDan congDan = congDanPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(congDan);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCongDan(CongDan congDan) throws SystemException {
		congDanPersistence.remove(congDan);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return congDanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return congDanPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return congDanPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return congDanPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CongDan fetchCongDan(long id) throws SystemException {
		return congDanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CongDan getCongDan(long id) throws PortalException, SystemException {
		return congDanPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return congDanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CongDan> getCongDans(int start, int end)
		throws SystemException {
		return congDanPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCongDansCount() throws SystemException {
		return congDanPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CongDan updateCongDan(CongDan congDan) throws SystemException {
		return updateCongDan(congDan, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CongDan updateCongDan(CongDan congDan, boolean merge)
		throws SystemException {
		congDan.setNew(false);

		congDan = congDanPersistence.update(congDan, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.dao.cd.model.CongDan",
			congDanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.cmon.dao.cd.model.CongDan");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = congDanPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(CongDanLocalServiceBaseImpl.class);
